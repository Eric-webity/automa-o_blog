...
def build_tab_profile_user(config) -> None:
    ...
    with ui.element("div").classes("geo-profile-page w-full"):
        ...
        layout_cls = "geo-profile-layout geo-profile-layout--split"
        with ui.element("div").classes(layout_cls):
            with ui.element("div").classes("geo-profile-layout__main"):
                with ui.element("section").classes("geo-profile-section"):
                    ...
                    name_input = geo_input(
                        "Nome completo", value=_field(record, "name") or display_name
                    )
                ...
                ).classes("geo-profile-save-btn self-start")

            if show_team_panel:
                with ui.element("aside").classes("geo-profile-layout__aside"):
                    render_add_user_panel(sidebar=True)
