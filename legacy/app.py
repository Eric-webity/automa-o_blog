"""
GEO Extractor — interface Streamlit (legado, congelada).

Use a interface principal: python main.py  (NiceGUI Content Studio)
...
# Raiz do repositório (pai de legacy/)
...
st.info("Interface legada. Para uso atual, execute `python main.py` (Content Studio).")
